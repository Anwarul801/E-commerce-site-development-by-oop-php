<div class="container">
					...
					<section class="products_container clearfix m_bottom_25 m_sm_bottom_15">
						...
						<div class="product_item">
							<figure class="r_corners photoframe shadow relative hit animate_ftb long">
								...
								<a href="#" class="d_block relative pp_wrap">
									...
									<img src="asset/frontEnd/images/product_img_1.jpg" class="tr_all_hover" alt="">
						...
						<div class="product_item featured">
							<figure class="r_corners photoframe shadow relative animate_ftb long">
								...
								<a href="#" class="d_block relative wrapper pp_wrap">
									<img src="asset/frontEnd/images/product_img_2.jpg" class="tr_all_hover" alt="">
						...
						<div class="product_item new">
							<figure class="r_corners photoframe shadow relative animate_ftb long">
								<!--product preview-->
								<a href="#" class="d_block relative wrapper pp_wrap">
									<img src="asset/frontEnd/images/product_img_3.jpg" class="tr_all_hover" alt="">
									<span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
								</a>
								<!--description and price of product-->
								<figcaption>
						...
						<div class="product_item specials">
							<figure class="r_corners photoframe shadow relative animate_ftb long">
								...
								<a href="#" class="d_block relative pp_wrap">
									<!--sale product-->
									<span class="hot_stripe"><img src="asset/frontEnd/images/sale_product.png" alt=""></span>
						...
						<div class="product_item hit">
							<figure class="r_corners photoframe shadow relative animate_ftb long">
								...
								<a href="#" class="d_block relative pp_wrap">
									<!--hot product-->
									<span class="hot_stripe type_2"><img src="asset/frontEnd/images/hot_product_type_2.png" alt=""></span>
						...
						<div class="product_item featured">
							<figure class="r_corners photoframe shadow relative animate_ftb long">
								<!--product preview-->
								<a href="#" class="d_block relative wrapper pp_wrap">
									<img src="asset/frontEnd/images/product_img_6.jpg" class="tr_all_hover" alt="">
									<span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
						...
						<div class="product_item specials">
							<figure class="r_corners photoframe shadow relative animate_ftb long">
								<!--product preview-->
								<a href="#" class="d_block relative wrapper pp_wrap">
									<img src="asset/frontEnd/images/product_img_7.jpg" class="tr_all_hover" alt="">
									<span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
								</a>
								<!--description and price of product-->
								<figcaption>
					...
					<div class="product_brands m_bottom_45 m_sm_bottom_35">
						<a href="#" class="d_block t_align_c animate_fade"><img src="asset/frontEnd/images/brand_logo.jpg" alt=""></a>
						<a href="#" class="d_block t_align_c animate_fade"><img src="asset/frontEnd/images/brand_logo.jpg" alt=""></a>
						<a href="#" class="d_block t_align_c animate_fade"><img src="asset/frontEnd/images/brand_logo.jpg" alt=""></a>
						<a href="#" class="d_block t_align_c animate_fade"><img src="asset/frontEnd/images/brand_logo.jpg" alt=""></a>
						<a href="#" class="d_block t_align_c animate_fade"><img src="asset/frontEnd/images/brand_logo.jpg" alt=""></a>
							...
							<div class="blog_carousel">
								<div class="clearfix">
									...
									<a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
										<img class="tr_all_long_hover" src="asset/frontEnd/images/blog_img_1.jpg" alt="">
									</a>
									<!--post content-->
								...
								<div class="clearfix">
									<!--image-->
									<a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
										<img class="tr_all_long_hover" src="asset/frontEnd/images/blog_img_2.jpg" alt="">
									</a>
									<!--post content-->
									<div class="mini_post_content">
								...
								<div class="clearfix">
									<!--image-->
									<a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
										<img class="tr_all_long_hover" src="asset/frontEnd/images/blog_img_3.jpg" alt="">
									</a>
									<!--post content-->
									<div class="mini_post_content">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 ti_animate animate_ftr">
							...
							<div class="testiomials_carousel">
								<div>
									...
									<img class="circle m_left_20 d_inline_middle animate_ftr" src="asset/frontEnd/images/testimonial_img_1.jpg" alt="">
								...
								<div>
									...
									<img class="circle m_left_20 d_inline_middle" src="asset/frontEnd/images/testimonial_img_2.jpg" alt="">
								...
								<div>
									...
									<img class="circle m_left_20 d_inline_middle" src="asset/frontEnd/images/testimonial_img_3.jpg" alt="">
									<div class="d_inline_middle m_left_15">
