...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	...
	<body>
						...
						<div class="col-lg-6 col-md-6 col-sm-8 t_align_r t_xs_align_c">
							<ul class="d_inline_b horizontal_list clearfix t_align_l site_settings">
								...
								<li class="m_left_5 relative container3d">
									<a role="button" href="#" class="button_type_2 color_dark d_block bg_light_color_1 r_corners tr_delay_hover box_s_none" id="lang_button"><img class="d_inline_middle m_right_10 m_mxs_right_0" src="../asset/frontEnd/images/flag_en.jpg" alt=""><span class="d_mxs_none">English</span></a>
									...
									<div class="shopping_cart top_arrow tr_all_hover r_corners">
										...
										<ul class="products_list">
											...
											<li>
												<div class="clearfix">
													<!--product image-->
													<img class="f_left m_right_10" src="../asset/frontEnd/images/shopping_c_img_2.jpg" alt="">
													<!--product description-->
													<div class="f_left product_description">
														<a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
														<span class="f_size_medium">Product Code PS34</span>
											...
											<li>
												<div class="clearfix">
													<!--product image-->
													<img class="f_left m_right_10" src="../asset/frontEnd/images/shopping_c_img_3.jpg" alt="">
													<!--product description-->
													<div class="f_left product_description">
														<a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
														<span class="f_size_medium">Product Code PS34</span>
							...
							<ul class="horizontal_list main_menu clearfix">
								...
								<li class="relative f_xs_none m_xs_bottom_5"><a href="category_grid.html" class="tr_delay_hover color_light tt_uppercase"><b>Shop</b></a>
									...
									<div class="sub_menu_wrap top_arrow d_xs_none tr_all_hover clearfix r_corners w_xs_auto">
										...
										<img src="../asset/frontEnd/images/woman_image_1.jpg" class="d_sm_none f_right m_bottom_10" alt="">
									</div>
								</li>
				...
				<div class="container">
					...
					<div class="row clearfix">
						<section class="col-lg-8 col-md-8 col-sm-8">
							<div class="photoframe r_corners shadow wrapper m_bottom_30">
								<img src="../asset/frontEnd/images/portfolio_img_37.jpg" alt="" class="tr_all_long_hover">
							</div>
							<div class="photoframe r_corners shadow wrapper m_bottom_30">
								<img src="../asset/frontEnd/images/portfolio_img_38.jpg" alt="" class="tr_all_long_hover">
							</div>
							<div class="photoframe r_corners shadow wrapper m_bottom_45">
								<img src="../asset/frontEnd/images/portfolio_img_39.jpg" alt="" class="tr_all_long_hover">
							</div>
						</section>
						<aside class="col-lg-4 col-md-4 col-sm-4 m_xs_bottom_30">
							...
							<script type="text/javascript" src="http://s7.addthis.com/../asset/frontEnd/js/300/addthis_widget.js#pubid=xa-5306f8f674bfda4c"></script>
						</aside>
					</div>
					...
					<div class="row clearfix">
						<div class="col-lg-4 col-md-4 col-sm-4 t_xs_align_c">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="../asset/frontEnd/images/portfolio_img_07.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
										<div class="f_left f_size_large tr_all_hover"><a href="../asset/frontEnd/images/img_01.jpg" role="button" class="color_light button_type_13 r_corners box_s_none d_block jackbox" data-group="portfolio" data-title="title 1"><i class="fa fa-camera"></i></a></div>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 t_xs_align_c">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="../asset/frontEnd/images/portfolio_img_08.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 t_xs_align_c">
							<figure class="d_xs_inline_b d_mxs_block">
								<div class="photoframe with_buttons relative shadow r_corners wrapper m_bottom_15">
									<img src="../asset/frontEnd/images/portfolio_img_09.jpg" alt="" class="tr_all_long_hover">
									<div class="open_buttons clearfix">
										<div class="f_left f_size_large tr_all_hover"><a href="../asset/frontEnd/images/img_03.jpg" role="button" class="color_light button_type_13 r_corners box_s_none d_block jackbox" data-group="portfolio" data-title="title 3"><i class="fa fa-camera"></i></a></div>
										<div class="f_left m_left_10 f_size_large tr_all_hover"><a href="portfolio_single_1.html" role="button" class="color_light button_type_13 r_corners box_s_none d_block"><i class="fa fa-link"></i></a></div>
									</div>
								</div>
								<figcaption class="t_xs_align_l">
				...
				<div class="footer_bottom_part">
					<div class="container clearfix t_mxs_align_c">
						...
						<ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
							<li><img src="../asset/frontEnd/images/payment_img_1.png" alt=""></li>
							<li class="m_left_5"><img src="../asset/frontEnd/images/payment_img_2.png" alt=""></li>
							<li class="m_left_5"><img src="../asset/frontEnd/images/payment_img_3.png" alt=""></li>
							<li class="m_left_5"><img src="../asset/frontEnd/images/payment_img_4.png" alt=""></li>
							<li class="m_left_5"><img src="../asset/frontEnd/images/payment_img_5.png" alt=""></li>
						</ul>
					</div>
				</div>
			</footer>
		...
		<script src="../asset/frontEnd/js/jackbox-packed.min.js"></script>
		<script src="../asset/frontEnd/js/retina.js"></script>
		<script src="../asset/frontEnd/js/waypoints.min.js"></script>
		<script src="../asset/frontEnd/js/jquery.tweet.min.js"></script>
